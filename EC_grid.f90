...
!  Declare functions
   ...
   public :: EC_gridi_new
   public :: EC_gridi_load
   public :: EC_gridi_write
   public :: EC_gridi_load_bin
   public :: EC_gridi_write_bin
   public :: EC_gridi_clone
   public :: EC_gridi_dump
   public :: EC_gridi_delete

!   public :: EC_gridr_load
!   public :: EC_gridr_write
!   public :: EC_gridr_load_bin
!   public :: EC_gridr_write_bin
!   public :: EC_gridr_clone
!   public :: EC_gridr_dump
!   public :: EC_gridr_delete
...
!==============================================================================
   subroutine EC_gridi_load_bin(fname,grid)
!  Load the ECgrid type from a binary file
...
!
!!==============================================================================
!   subroutine EC_gridr_load_bin(fname,grid)
...
!   integer :: iostatus,ix,iy,iz,k
!   
!   write(lu_stderr,'(a)') 'EC_gridr_load_bin hasn''t been tested yet!'
!   stop
!   
!   open(20,file=fname,iostat=iostatus,form='unformatted',status='old')
!   if (iostatus /= 0) then
...
!   endif
!   
!   read(20) grid%npts, grid%nx, grid%ny, grid%nz, grid%x1, grid%x2, &
...
!   
!!  Write the header line
!   write(20) grid%npts, grid%nx, grid%ny, grid%nz, grid%x1, grid%x2, &
!             grid%y1, grid%y2, grid%z1, grid%z2, grid%dx, grid%dy, grid%dz
!             
!!  Write the elastic constants
!   do ix=1,grid%nx
