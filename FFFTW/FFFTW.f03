...
!    private
   ...
   interface FFFTW_rev
      ...
      module procedure :: FFFTW_rev_c2r_1d_real8
!       module procedure :: FFFTW_rev_c2c_1d_complex4
!       module procedure :: FFFTW_rev_c2c_1d_complex8
   end interface FFFTW_rev

   interface FFFTW_allocate
      module procedure :: FFFTW_allocate_real4
      module procedure :: FFFTW_allocate_real8
      module procedure :: FFFTW_allocate_complex4
      module procedure :: FFFTW_allocate_complex8
