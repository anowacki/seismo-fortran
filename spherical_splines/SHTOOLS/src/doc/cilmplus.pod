...
CILM(2, LMAX+1, LMAX+1), GRIDIN(LMAX+1, 2*LMAX+1), MASS, D, RHO, 
...
shexpandglq(1), makegridglq(1), precompute(1), preglq(1), glqgridcoord(1), makegriddh(1)
