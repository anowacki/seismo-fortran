...
An array of the first derivatives of the geodesy-normalized associated Legendre functions up to degree LMAX. The index corresponds to L*(L+1)/2 + M + 1, which can be calculated by a call to I<PlmIndex>.
