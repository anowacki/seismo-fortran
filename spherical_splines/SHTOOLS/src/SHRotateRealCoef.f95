...
!
!	Dependencies:	SHrtoc, SHctor, SHcilmtocindex, SHcindextocilm, SHRotateCoef, CSPHASE_DEFAULT
!
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	use SHTOOLS, only: SHrtoc, SHctor, SHcilmtocindex, SHcindextocilm, SHRotateCoef, CSPHASE_DEFAULT
