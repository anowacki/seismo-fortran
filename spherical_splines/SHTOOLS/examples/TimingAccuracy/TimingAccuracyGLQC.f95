...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	do lmax=100, maxdeg, 100
		...
		call MakeGridGLQC(gridglq(1:lmax+1, 1:2*lmax+1), cilm(1:2,1:lmax+1, 1:lmax+1), lmax, zero=zero(1:lmax+1), norm=1)
		call cpu_time(timeout(2))
				
		call cpu_time(timein(3))
		call SHExpandGLQC(cilm2(1:2, 1:lmax+1, 1:lmax+1), lmax, gridglq(1:lmax+1, 1:2*lmax+1), w, zero=zero(1:lmax+1), norm=1)
